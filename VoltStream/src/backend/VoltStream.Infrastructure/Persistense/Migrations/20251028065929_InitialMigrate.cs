    ...
    public partial class InitialMigrate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountsOperations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DiscountsOperations_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscountsOperations_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_DiscountsOperations_DiscountOperationId",
                        column: x => x.DiscountOperationId,
                        principalTable: "DiscountsOperations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Sales_DiscountsOperations_DiscountOperationId",
                        column: x => x.DiscountOperationId,
                        principalTable: "DiscountsOperations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountsOperations_AccountId",
                table: "DiscountsOperations",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscountsOperations_CustomerId",
                table: "DiscountsOperations",
                column: "CustomerId");
