...
public partial class SuppliesPage : Page
{
    ...
    private async void addSupplyBtn_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            System.Diagnostics.Debug.WriteLine($"API javobi: StatusCode={response.StatusCode}, ContentId={response.Content?.Id}");
            if (response.IsSuccessStatusCode && response.Content != null)
            {
                MessageBox.Show("Ta'minot muvaffaqiyatli qo‘shildi!", "Muvaffaqiyat", MessageBoxButton.OK, MessageBoxImage.Information);
